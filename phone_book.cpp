...
//phonebook with functionality to add, delete, and retreive a name associated
//with a phone number
...
//uses direct addressing to avoid having to search over whole vector
//phone numbers can be max. 7 digits
vector<string> process_queries2(const vector<Query>& queries) {
	vector<string> result;
	
	//replacing Query vector with a string vector
	//strings are names of contacts
